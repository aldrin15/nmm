			...
			<div class="panel-body bio-graph-info">
				<?php foreach($details as $detail): ?>
					<div class="row">
						...
						<p><span>Driver Name </span>: <?php echo $detail['firstname']?> <?php echo $detail['lastname']?></p>
						<p><span>Storage </span>: <?php echo $detail['storage']?></p>
						<p><span>Available seat(s) </span>: <?php echo $detail['available']?></p>
						<p><span>Price/seat</span>: <?php echo $detail['amount']?></p>
						<p><span>Date & Time </span>: <?php echo $detail['start_time']?></p>
